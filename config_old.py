...
filtros_ont = """<div class="tab-content">
...
modalont = """
				<!-- Modal -->
				<div id="modal_alta_ont" class="modal" role="dialog">
        ...
        <form name="altacliente" class="form-horizontal" autocomplete="off" role="form" action="honeyajax.php" method="post" id="form_nuevo_cliente">
                    ...
                    <div class="form-group">
                    	...
                    	<div id='extensionsip' class="form-group sip hidden">
                    			...
                    			<div class="col-sm-10" style="width:200px">
                    				<input type="text" class="form-control" id="inputextensionsip" name="inputextensionsip" placeholder="Teléfono sin espacios" minlength=9 maxlength=15 required autocomplete="new-password" disabled/>
                    			</div>
                    		</div>
      ...
      <div class="modal-body">
        <form name="editar_cliente" class="form-horizontal" autocomplete="off" role="form" action="honeyajax.php" method="post" id="form_editar_cliente">
                    ...
                    <span class="hidden">
                        ...
                        <div class="col-sm-10" style="width:25px">
                           <input type="checkbox" class="form-control" style='width:20px;height:20px' id="editar_inputcgnat" name="editar_inputcgnat" value="cgnat"/>
                        </div>
                    </span>
                    <span class="hidden">
                        <label class="col-sm-2 control-label" style="color:#286090">
                        ...
                        <div class="col-sm-10" style="width:25px">
                           <input type="checkbox" onchange="functionbridge()" class="form-control" style='width:20px;height:20px' id="editar_inputbridge" name="editar_inputbridge" value="bridge"/>
                        </div>
                    </span>
                    	<label class="col-sm-2 control-label" style="color:#286090">
                           VoIP
                        ...
                        <div class="col-sm-10" style="width:25px">
                           <input type="checkbox" class="form-control" style='width:20px;height:20px' id="editar_inputsip" name="editar_inputsip" value="sip" onclick="edit_camposip()"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group checkboxes_services">
                        ...
                        <div class="col-sm-10" style="width:250px">
                            ...
                            <select onchange="loadoltlist($('#editar_cliente_selectplan option:selected').val())" id='editar_cliente_selectplan' name="editar_selectplan" class="form-control" required>
                            <option value='' selected disabled>Seleccionar</option>
                        ...
                        <div class="col-sm-10" style="width:250px">
                          ...
                          <select id='editar_cliente_selectolt' name="editar_selectolt" class="form-control" required>
                              <option value='' selected disabled>Seleccionar</option>
                    	...
                    	<div id='extensionsip' class="form-group editar_sip hidden">
                    			...
                    			<div class="col-sm-10" style="width:200px">
                    				<input type="text" class="form-control" id="editar_inputextensionsip" name="editar_inputextensionsip" placeholder="Teléfono sin espacios" minlength=9 maxlength=15 required autocomplete="new-password" disabled/>
                    			</div>
                    		</div>
                    		<div id='secretsip' class="form-group editar_sip hidden">
                    			...
                    			<div class="col-sm-10" style="width:200px">
                    				<input type="password"  class="form-control" id="editar_inputsecretsip" name="editar_inputsecretsip" minlength=4 maxlength=25 required autocomplete="new-password" disabled />
                    			</div>
                    		</div>
                            <div id='serversip' class="form-group editar_sip hidden">
                    			...
                    			<div class="col-sm-10" style="width:200px">
                                    <select id='editar_inputserversip' name="editar_inputserversip" class="form-control" required disabled>
